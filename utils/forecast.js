...
const forecast = (latitude, longitude, callback) => {
    const weatherstackURL = 'http://api.weatherstack.com/current?access_key=62ba8e98565a8d0fed54f9a8eb9efff2&query=' + latitude + ',' + longitude + '&units=f'
